          ...
          <div className="bg-black/90 p-8 rounded-xl shadow-sm border border-[color:var(--theme-primary)]/20">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="text-right">
                <Badge className="bg-[color:var(--theme-primary)]/20 text-[color:var(--theme-primary)] border-[color:var(--theme-primary)]/30">Present</Badge>
                <p className="text-gray-300 font-medium mt-1">Aug 2025 – Present</p>
              </div>
            </div>
